...
export default function AddTenantBikePage() {
  const [errorAddTenantBike, setErrorAddTenantBike] = useState<
  ...
  console.log(errorAddTenantBike);
  ...
  const queryVehicle = queryVehicleRaw.filter((vehicle: unitVehicleType) => {
    ...
    const matchType = vehicle.vehicleType === "Bike";

    return matchStatus && matchType;
  });

  // Add Tenant API
  const AddTenantBikeMutation = useMutation({
    ...
    onError: (error) => {
      ...
      if (axios.isAxiosError(error)) {
        ...
        setErrorAddTenantBike(newError);
      } else {
  ...
  function handleAddTenantBike(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
    const AddTenantBikeForm = new FormData(e.currentTarget);

    const AddTenantBikeData = {
      name: AddTenantBikeForm.get("TenantName"),
      age: AddTenantBikeForm.get("TenantAge"),
      email: AddTenantBikeForm.get("TenantEmail"),
      phoneNumber: AddTenantBikeForm.get("TenantPhoneNumber"),
      address: {
        residentialAddress: AddTenantBikeForm.get("TenantResidentialAddress"),
        originAddress: AddTenantBikeForm.get("TenantOriginAddress"),
      },
      background: {
        job: AddTenantBikeForm.get("TenantBackgroundJob"),
        institution: AddTenantBikeForm.get("TenantBackgroundInstitution"),
        position: AddTenantBikeForm.get("TenantBackgroundPosition"),
      },
      parentInformation: {
        parentName: AddTenantBikeForm.get("TenantParentName"),
        parentPhoneNumber: AddTenantBikeForm.get("TenantParentPhoneNumber"),
      },
      collateral: {
        amount: AddTenantBikeForm.get("TenantCollateralAmount"),
        collateralType: AddTenantBikeForm.get("TenantCollateralType"),
      },
      vehicleInformation: {
        vehicle: AddTenantBikeForm.get("TenantVehicleID"),
        helmetAmount: Number(AddTenantBikeForm.get("TenantHelmetAmount")),
        raincoatAmount: Number(AddTenantBikeForm.get("TenantRaincoatAmount")),
        rentalStartDate: AddTenantBikeForm.get("TenantRentalStartDate"),
        rentalEndDate: AddTenantBikeForm.get("TenantRentalEndDate"),
      },
      payment: {
        paymentMethod: AddTenantBikeForm.get("TenantPaymentMethod"),
        paidOff: AddTenantBikeForm.get("TenantPaidOff"),
        unpaidFees: Number(AddTenantBikeForm.get("TenantUnpaidFees")),
        totalPriceAmount: 0,
      },
      isActive: true,
    };

    console.log(AddTenantBikeData);

    const validatedAddTenantBikeData =
      tenantVehicle.safeParse(AddTenantBikeData);
    if (!validatedAddTenantBikeData.success) {
      validatedAddTenantBikeData.error;

      const newErrors: Record<string, string> = {};

      validatedAddTenantBikeData.error?.issues.forEach((issue) => {
        const field = issue.path.join(".");
        newErrors[field] = issue.message;
      });

      setErrorAddTenantBike(newErrors);
    } else {
      validatedAddTenantBikeData.success;
      setErrorAddTenantBike({});
      AddTenantBikeMutation.mutate(validatedAddTenantBikeData.data);
    }
  }
      ...
      <div className="py-20">
        <div className="flex items-center justify-center">
          <div className="text-xl font-bold my-4">
            Form Tambah Penyewa Motor
          </div>
        </div>
        <div className="w-full">
          <form action="" method="post" onSubmit={handleAddTenantBike}>
            <div className={pageCounter === 1 ? "block" : "hidden"}>
              <VehicleTenantData
                errorAddTenantBike={errorAddTenantBike}
                queryVehicle={queryVehicle}
              />
            </div>
            <div className={pageCounter === 2 ? "block" : "hidden"}>
              <UserTenantData errorAddTenantBike={errorAddTenantBike} />
            </div>
            <div className={pageCounter === 3 ? "block" : "hidden"}>
              <PaymentTenantData errorAddTenantBike={errorAddTenantBike} />
            </div>
            {pageCounter === 1 ? (
...
type VehicleDataProps = {
  errorAddTenantBike: Record<string, string>;
};
    ...
    <div className="flex flex-col justify-center">
      ...
      <div className="flex flex-col justify-center px-8">
        ...
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["vehicleInformation.vehicle"] ?? (
            <p>{errorAddTenantBike["vehicleInformation.vehicle"]}</p>
          )}
        </div>
        <label className="mt-2 mb-1" htmlFor="TenantHelmetAmount">
          Jumlah Helm
        </label>
        ...
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["vehicleInformation.helmetAmount"] ?? (
            <p>{errorAddTenantBike["vehicleInformation.helmetAmount"]}</p>
          )}
        </div>
        <label className="mt-2 mb-1" htmlFor="TenantRaincoatAmount">
          Jumlah Jas Hujan
        </label>
        ...
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["vehicleInformation.raincoatAmount"] ?? (
            <p>{errorAddTenantBike["vehicleInformation.raincoatAmount"]}</p>
          )}
        </div>
        ...
        />
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["vehicleInformation.rentalStartDate"] ?? (
            <p>{errorAddTenantBike["vehicleInformation.rentalStartDate"]}</p>
          )}
        </div>
        ...
        />
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["vehicleInformation.rentalEndDate"] ?? (
            <p>{errorAddTenantBike["vehicleInformation.rentalEndDate"]}</p>
          )}
        </div>
      </div>
    </div>
...
function UserTenantData({ errorAddTenantBike }: VehicleDataProps) {
  return (
    <div className="flex flex-col justify-center">
      <div className="px-4 mt-3 mb-1">
      ...
      <div className="flex flex-col justify-center px-8">
        ...
        />
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["name"] ?? <p>{errorAddTenantBike["name"]}</p>}
        </div>
        ...
        />
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["age"] ?? <p>{errorAddTenantBike["age"]}</p>}
        </div>
        ...
        />
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["email"] ?? <p>{errorAddTenantBike["email"]}</p>}
        </div>
        ...
        />
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["phoneNumber"] ?? (
            <p>{errorAddTenantBike["phoneNumber"]}</p>
          )}
        </div>
      </div>
      <div className="px-4 mt-3 mb-1">
      ...
      <div className="flex flex-col justify-center px-8">
        ...
        />
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["address.originAddress"] ?? (
            <p>{errorAddTenantBike["address.originAddress"]}</p>
          )}
        </div>
        ...
        />
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["address.residentialAddress"] ?? (
            <p>{errorAddTenantBike["address.residentialAddress"]}</p>
          )}
        </div>
      </div>
      <div className="px-4 mt-3 mb-1">
      ...
      <div className="flex flex-col justify-center px-8">
        ...
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["background.job"] ?? (
            <p>{errorAddTenantBike["background.job"]}</p>
          )}
        </div>
        ...
        />
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["background.institution"] ?? (
            <p>{errorAddTenantBike["background.institution"]}</p>
          )}
        </div>
        ...
        />
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["background.position"] ?? (
            <p>{errorAddTenantBike["background.position"]}</p>
          )}
        </div>
      </div>
      <div className="px-4 mt-3 mb-1">
      ...
      <div className="flex flex-col justify-center px-8">
        ...
        />
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["parentInformation.parentName"] ?? (
            <p>{errorAddTenantBike["parentInformation.parentName"]}</p>
          )}
        </div>
        ...
        />
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["parentInformation.parentPhoneNumber"] ?? (
            <p>{errorAddTenantBike["parentInformation.parentPhoneNumber"]}</p>
          )}
        </div>
      </div>
    </div>
...
function PaymentTenantData({ errorAddTenantBike }: VehicleDataProps) {
  return (
    <div className="flex flex-col justify-center">
      <div className="px-4 mt-3 mb-1">
      ...
      <div className="flex flex-col justify-center px-8">
        ...
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["collateral.amount"] ?? (
            <p>{errorAddTenantBike["collateral.amount"]}</p>
          )}
        </div>
        ...
        />
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["collateral.collateralType"] ?? (
            <p>{errorAddTenantBike["collateral.collateralType"]}</p>
          )}
        </div>
      </div>
      <div className="px-4 mt-3 mb-1">
      ...
      <div className="flex flex-col justify-center px-8">
        ...
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["payment.paymentMethod"] ?? (
            <p>{errorAddTenantBike["payment.paymentMethod"]}</p>
          )}
        </div>
        ...
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["payment.paidOff"] ?? (
            <p>{errorAddTenantBike["payment.paidOff"]}</p>
          )}
        </div>
        ...
        />
        <div className="text-red-500 mt-0 mb-1 text-xs">
          {errorAddTenantBike["payment.unpaidFees"] ?? (
            <p>{errorAddTenantBike["payment.unpaidFees"]}</p>
          )}
        </div>
      </div>
    </div>
